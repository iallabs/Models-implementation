#Inspired and taken from https://github.com/tensorflow/models/blob/master/research/slim/nets/nets_factory.py
...
network_map = {
    ...
    'densenet_161': densenet.densenet161,
    'densenet_169': densenet.densenet169
}

arg_scopes_map = {'densenet': densenet.densenet_arg_scope}
...
def get_network_fn(name, num_classes, weight_decay=0.0, is_training=False):
    ...
    Args:
        ...
        otherwise.
    Returns:
        network_fn: A function that applies the model to a batch of images. It ha
