#Taken from Slim library: https://github.com/tensorflow/models/blob/master/research/slim/preprocessing/vgg_preprocessing.py
...
_R_MEAN = 123.675/(2*255)
_G_MEAN = 116.535/(2*255)
_B_MEAN = 104.04/(2*255)
