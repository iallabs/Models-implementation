...
#Emplacement du checkpoint file. TODO: Change checkpoint_file, using FLAGS
checkpoint_file= "mobilenet_v1_0.5_160.ckpt"

image_size = 224
#Nombre de classes à prédire
num_class = 2

#TODO: Change file_pattern and file_pattern_for_counting to match your dataset
...
#TODO: Fill the dictionnary with the map label to name
labels_to_name = {0:'cat', 1:'dog'}

#Create a dictionary that will help people understand your dataset better. This is required by the Dataset class later.
items_to_descriptions = {
    'image': 'A 3-channel RGB coloured flower image that is either... ....',
    'label': 'A label that is as such -- 0:cat, 1:dog'
}
